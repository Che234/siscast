class constancias{
    ...
    test1(){
        ...
        if(!ex_datcort.test(this.ambInmue)){
            alert("Error en el formato de Ambito del Inmueble");
            return false;
        }
        return true;
    }
