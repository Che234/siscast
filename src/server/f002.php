...
class f004{
    ...
    function imprimir(){
        ...
        //CONTINUACION HEADER
            ...
            $pdf->SetY(58);
            $pdf->SetX(140);
            $pdf->cell(40,10,utf8_decode('N° de Factura: '.$idExpFact["n_factura"].''));
            $pdf->SetY(62);
            $pdf->SetX(22);
            $pdf->cell(40,10,utf8_decode('N° Civico: No Aplica'));
            $pdf->SetY(62);
            $pdf->SetX(136);
            $pdf->cell(40,10,utf8_decode('N° de Expediente: IAMOTFF/Nº '.$busExpedienteRes["n_expediente"].''));
            $pdf->SetY(66);
            $pdf->SetX(22);
        ...
        //DATOS DEL PROPIETARIO
            ...
            $pdf->SetY(94);
            $pdf->SetX(19);
            $pdf->cell(46,5,utf8_decode('N° de Cedula'),1,0,'L');
            $pdf->SetY(94);
            $pdf->SetX(65);
            if($ced[0]=="N/A"){
