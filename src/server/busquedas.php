    ...
    //PAGOS
        ...
        function verPagos(){
            ...
            //BUSQUEDA DE CANTIDAD DE PAGOS
                $veriPagoSql = "SELECT COUNT(*) FROM pagos where fk_expedient=".$expediente." ORDER BY fechaPagos";
            ...
            <table>
                ...
                echo'<tr>
                    ...
                    //BUSQUEDA DE PAGOS
                        $pagoSql = "SELECT * FROM pagos where fk_expedient=".$expediente." ";
