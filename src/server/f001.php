...
class f1{
    ...
    function imprimir(){
        ...
        //REDACCION
            ...
            $pdf->SetX(19);
            $pdf->SetFont('Times','B',10);
            $pdf->cell(50,4,utf8_decode('Revisado por:'),0,'C');
            $pdf->SetY(256);    
            $pdf->SetX(42);
            $pdf->SetFont('Times','',10);
            $pdf->cell(50,4,utf8_decode('Abg. Gabriel Tocuyo'),0,'C');
            $pdf->SetY(261);    
            $pdf->SetX(19);
            $pdf->SetFont('Times','B',10);
        ...
        //FIRMA
            ...
            $pdf->SetLineWidth(0.5);
            $pdf->MultiCell(73,5,utf8_decode('ING. ANA GABRIELA GARCIA HERNANDEZ PRESIDENTE DEL INSTITUTO AUTONOMO MUNICIPAL DE ORDENAMIENTO TERRITORIAL DEL MUNICIPIO FERNANDEZ FEO (I.A.M.O.T.F.F.) SEGÚN RESOLUCIÓN NRO. ABSMFF/2020-080 BAJO GACETA MUNICIPAL N° 242'),'T:1','C');
