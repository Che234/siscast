...
class f001{
    ...
    // $link= new mysqli("127.0.0.1", "root","","siscast") 
        ...
        //DATOS DEL PROPIETARIO
            ...
            $pdf->SetY(123);
            $pdf->SetX(65);
            if($resultPropieDe["rif"]=="N/A"){
                $pdf->cell(0,6,'',1,0,'L');
                if($resultPropieDe["rif"]=="NO APLICA"){
                    $pdf->cell(0,6,'',1,0,'L');
                }else{
        ...
        //DATOS DE COLINDANTES SEGUN DOCUMENTO
            ...
            $pdf->SetY(177);
            $pdf->SetX(54);
            $pdf->cell(105,6,'Alinderado',1,0,'C');
            $pdf->SetY(177);
            $pdf->SetX(159);
            ...
            $pdf->SetY(183);
            $pdf->SetX(54);
            $pdf->cell(105,6,utf8_decode(''.$resultLindDoc["alind_n"].''),1,0,'C');
            $pdf->SetY(183);
            $pdf->SetX(159);
            ...
            $pdf->SetY(189);
            $pdf->SetX(54);
            $pdf->cell(105,6,utf8_decode(''.$resultLindDoc["alind_s"].''),1,0,'C');
            $pdf->SetY(189);
            $pdf->SetX(159);
            if($resultLindDoc["sur"]!="nada"){
            ...
            $pdf->SetY(195);
            $pdf->SetX(54);
            $pdf->cell(105,6,utf8_decode(''.$resultLindDoc["alind_e"].''),1,0,'C');
            $pdf->SetY(195);
            $pdf->SetX(159);
            if($resultLindDoc["este"]!="nada"){
            ...
            $pdf->SetY(201);
            $pdf->SetX(54);
            $pdf->cell(105,6,utf8_decode(''.$resultLindDoc["alind_o"].''),1,0,'C');
            $pdf->SetY(201);
            $pdf->SetX(159);
            if($resultLindDoc["oeste"]!="nada"){
        ...
        //SERVICIOS 1
            $pdf->SetY(219);    
            $pdf->SetX(19);
            $pdf->cell(25,22,'Servicios',1,0,'C');
            $pdf->SetY(219);    
            $pdf->SetX(44);
            $pdf->cell(0,22,'',1,0,'C');
            $pdf->SetY(219);    
        ...
        //CARACTERISTICAS DEL TERRENO
            ...
            $pdf->SetY(280);    
            $pdf->SetX(19);
            $pdf->cell(110,14,'',1,0,'L'); //CUADRO DE OBSERVACIONES
            $pdf->SetY(302);    
            $pdf->SetX(20);
