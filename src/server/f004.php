...
class PDF4 extends FPDF
{
    ...
    function Footer(){
        ...
        $this->Image('../../../assets/fondoFooter.jpg',20,308,170,14);
        $this->SetY(309);    
        $this->SetX(71);
    ...
    function imprimir(){
       ...
       //CONTINUACION HEADER
        ...
        //DATOS DE COLINDANTES SEGUN INSPECCION
            ...
            $pdf->SetY(195);    
            $pdf->SetX(19);
            $pdf->cell(35,6,'Area de Terreno',1,0,'C');
            $pdf->SetY(195);    
            $pdf->SetX(54);
            if($resultLindGen["areaTotal"]=="NO APLICA"){
                ...
                if($resultLindGen["uniAreaT"]=="N/A"){
                    ...
                    $pdf->cell(25,6,''.$resultLindGen["areaTotal"].' '.$resultLindGen["uniAreaT"].'',1,0,'C');
                }
            }
            $pdf->SetY(195);    
            $pdf->SetX(79);
            ...
            if($resultLindGen["nivelesConst"]=="NO APLICA"){
                $pdf->cell(35,6,'NO APLICA',1,0,'C');
            }else{
                $pdf->cell(35,6,''.$resultLindGen["nivelesConst"].'',1,0,'C');
            }
            $pdf->SetY(195);    
            $pdf->SetX(149);
            ...
            if($resultLindGen["areaConst"]=="NO APLICA"){
                $pdf->cell(0,6,'NO APICA',1,0,'C');
            }else{
                if($resultLindGen["uniAreaC"]=="N/A"){
                    $pdf->cell(0,6,'NO APLICA',1,0,'C');
                }else{
                    $pdf->cell(0,6,''.$resultLindGen["areaConst"].' '.$resultLindGen["uniAreaC"].'',1,0,'C');
                }
            }
        //PARTE 6
            $pdf->SetY(201);    
        ...
        //SERVICIOS 2
            $pdf->SetY(220);    
            $pdf->SetX(78);
            $pdf->cell(30,6,'Pavimento Flexible',0,0,'L');
            $pdf->SetY(221);    
            $pdf->SetX(108);
            ...
            $pdf->SetY(224);    
            $pdf->SetX(78);
            $pdf->cell(30,6,'Pavimento Rigido',0,0,'L');
            $pdf->SetY(225);    
            $pdf->SetX(108);
            ...
            $pdf->SetY(228);    
            $pdf->SetX(78);
            $pdf->cell(30,6,utf8_decode('Vía Engranzonada'),0,0,'L');
            $pdf->SetY(229);    
            $pdf->SetX(108);
        ...
        //SERVICIOS 3
            $pdf->SetY(220);    
            $pdf->SetX(114);
            $pdf->cell(30,6,utf8_decode('Alumbrado Público'),0,0,'L');
            $pdf->SetY(221);    
            $pdf->SetX(144);
            ...
            $pdf->SetY(228);    
            $pdf->SetX(114);
            $pdf->cell(30,6,utf8_decode('Transporte Público'),0,0,'L');
            $pdf->SetY(229);    
            $pdf->SetX(144);
            ...
            $pdf->SetY(232);    
            $pdf->SetX(114);
            $pdf->cell(30,6,utf8_decode('Pozo Séptico'),0,0,'L');
            $pdf->SetY(233);    
            $pdf->SetX(144);
        ...
        //CARACTERISTICAS DEL TERRENO
            ...
            //TENENCIA
                ...
                $pdf->SetY(272);    
                $pdf->SetX(19);
                $pdf->cell(77,14,'',1,0,'L');// CUADRO DE OBSERVACIONES
                $pdf->SetY(248);    
                $pdf->SetX(96);
